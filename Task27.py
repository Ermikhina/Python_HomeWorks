# №4.2[27]. Дана строка, состоящая из слов. Словом считается последовательность непробельных символов
...
# Curabitur a tellus ut arcu gravida porta eget a lacus. Curabitur ornare varius turpis, ultricies mollis
# sem convallis in. Nunc scelerisque lacinia risus sit amet aliquam.
...
new_list = set(input_string.split())
print(new_list)
