# №2.3[13]. Уставшие от необычно теплой зимы, жители решили узнать, действительно ли это
...
# помогающую синоптикам в работе. Пользователь вводит число N – общее количество рассматриваемых
# дней (1 ≤ N ≤ 100). Затем пользователь последовательно вводит температуру для каждого дня.
# Температуры – целые числа и лежат в диапазоне от –50 до 50. Необходимо вычислить длительность
# самой длинной оттепели
# Примеры/Тесты:
...
str = ""
for i in range (days ):
    temp = input(f"Введите среднесуточную температуру для дня {i+1}: ")
...
if maxCount <count:
    maxCount =count
print (str)
print (f"Максимальная длительность оттепели {maxCount} дн.")