# №64.4[45] Два различных натуральных числа n и m называются дружественными, если сумма делителей числа n
...
# Напишите функцию:
# Аргументы: целое число. Печатает все пары дружественных чисел, не превосходящих аргумент.
...
# Comprehension:
# [list3[i+1] for i in range(len(list3)-1) if list3[i]< list3[i+1]]
